...
def process_images(image_paths):
    ...
    for image_path in image_paths:
        ...
        if image_path.lower().endswith('.png'):
            ...
            desktop_webp = os.path.join(output_folder, os.path.basename(image_path).replace(".jpg", ".webp").replace(".jpeg", ".webp").replace('.JPG', ".webp"))
            mobile_webp = os.path.join(output_folder, os.path.basename(image_path).replace(".jpg", "-m.webp").replace(".jpeg", "-m.webp").replace('.JPG', ".webp"))
